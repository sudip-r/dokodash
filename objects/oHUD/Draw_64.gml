...
if (instance_exists(player)) {
    ...
    draw_text(32, 152, "Doko Items: " + string(player.doko_items));
}
...
if (instance_exists(game)) {
    ...
    draw_text(32, 192, "Delivery: " + string(percent) + "%");

    if (game.slow_timer > 0) {
        draw_text(32, 232, "Slowed!");
    }
    ...
    if (game.game_state == "complete") {
        ...
        draw_text(360, 500, "Delivery Complete!");

        if (instance_exists(player)) {
            draw_text(360, 560, "Points: " + string(player.points));
            draw_text(360, 620, "Doko Items: " + string(player.doko_items));
        }

        draw_text(360, 700, "Tap or Press R to Restart");
